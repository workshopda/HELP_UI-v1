...
<div class="m-auto w-full max-w-6xl px-2 @2xl:px-20 translate-y-6 py-24 text-center">
    ...
    >
        <div class="w-full flex flex-col justify-center items-center">
            <!-- Model Image + Name + Hindu Engineering Learning Partner Text -->
            <div class="flex flex-col justify-center items-center gap-2">
                <div class="flex -space-x-4 mb-0.5 items-center" in:fade={{ duration: 100 }}>
                ...
                <!-- "Hindu Engineering Learning Partner" added here -->
                <div class="text-base font-medium text-gray-600 dark:text-gray-400 mt-1">
                    Hindu Engineering Learning Partner
                </div>
            </div>
            ...
            <div class="text-base font-normal @md:max-w-3xl w-full py-3">
                <MessageInput
                    ...
                    {stopResponse}
                    {createMessagePair}
                    placeholder={$i18n.t('Need info on the syllabus? Ask away!')}
                    onChange={(input) => {
                        if (!$temporaryChatEnabled) {
