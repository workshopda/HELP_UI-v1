<script lang="ts">
	...
	let navElement;
	let shiftKey = false;
	// Define hoverState as a writable store or reactive variable
...
>
	...
	>
		<div class="px-1.5 flex justify-between space-x-1 text-gray-600 dark:text-gray-400">
			...
			<div class="flex items-center w-full mt-2 mb-1 px-3">
				<h2 class="text-lg md:text-xl font-bold text-gray-800 dark:text-gray-200 font-primary select-none">
					H.E.L.P
				</h2>
			</div>
    ...
    class="flex items-center justify-start gap-3 group rounded-lg px-3 py-1.5 hover:bg-gray-100 dark:hover:bg-gray-800 transition-all duration-200 cursor-pointer no-drag-region"
    href="/"
    draggable="false"
    on:click={async () => {
        selectedChatId = null;
